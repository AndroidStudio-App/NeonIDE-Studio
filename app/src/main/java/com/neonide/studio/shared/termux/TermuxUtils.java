...
import com.neonide.studio.shared.reflection.ReflectionUtils;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.neonide.studio`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.neonide.studio/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.neonide.studio" />
     *    </queries>
     * </manifest>
     * }
     *
