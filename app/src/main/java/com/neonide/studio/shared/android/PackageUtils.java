package com.neonide.studio.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.neonide.studio.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.neonide.studio/10xxx}
             */
