package com.neonide.studio.shared.termux.settings.preferences;
...
import com.neonide.studio.shared.settings.preferences.AppSharedPreferences;
import com.neonide.studio.shared.settings.preferences.SharedPreferenceUtils;
...
public class TermuxAppSharedPreferences extends AppSharedPreferences {
    ...
    public boolean isIdeFileLoggingEnabled() {
        return SharedPreferenceUtils.getBoolean(mSharedPreferences,
            TERMUX_APP.KEY_IDE_FILE_LOGGING_ENABLED,
            TERMUX_APP.DEFAULT_VALUE_IDE_FILE_LOGGING_ENABLED);
    }
