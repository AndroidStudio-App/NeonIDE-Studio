package com.neonide.studio.shared.activities;
...
import com.neonide.studio.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.neonide.studio.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.neonide.studio.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
