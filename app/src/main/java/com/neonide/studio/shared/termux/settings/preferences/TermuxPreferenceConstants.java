 ...
 *          Termux app and its plugins. This will allow {@link com.neonide.studio.app.TermuxSettings} to
...
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * Defines the key for whether IDE logs should also be written to a file in public storage
         * (Documents directory). This is useful when users cannot access logcat.
         */
